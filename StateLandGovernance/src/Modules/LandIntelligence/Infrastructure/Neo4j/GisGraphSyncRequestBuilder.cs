...
public sealed class GisGraphSyncRequestBuilder : IGisGraphSyncRequestBuilder
{
    private readonly LandIntelligenceDbContext _dbContext;

    public GisGraphSyncRequestBuilder(LandIntelligenceDbContext dbContext)
    {
        _dbContext = dbContext;
    }

    public async Task<GisDerivedParcelIntelligenceGraphSyncRequest?> BuildSyncRequestAsync(
        Guid parcelId,
